...
export async function getPublicResults(slug: string) {
  ...
  return { questionSummaries, totalResponses };
}
...
export async function submitResponse(
  ...
  if (poll.responseMode === 'anonymous') {
    ...
    return { isNewCookie: !req.cookies?.respondentId, pollId: poll._id.toString(), respondentId };
  }
  ...
  return { isNewCookie: false, pollId: poll._id.toString(), respondentId: null };
}
