...
const features = [
  ...
  },
  {
    ...
    description:
      "Share via email, social media, or embed. Respondents land straight on your poll.",
  },
  {
    icon: Eye,
  ...
  },
  {
    ...
    description:
      "Multiple people can watch analytics simultaneously with live Socket.IO updates.",
  },
];
      ...
      <div className="mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="mt-3 text-lg text-muted-foreground">
            Everything you need to ask, collect, and understand what your
            audience thinks.
          </p>
        </div>
