    ...
    >
      <section id="acceptance" className="mb-14 scroll-mt-28">
        ...
        <p className="text-base leading-relaxed text-foreground">
          ...
          not agree with any part of these terms, you must discontinue your use
      ...
      <section id="acceptable-use" className="mb-14 scroll-mt-28">
        ...
        <p className="mb-4 text-base leading-relaxed text-foreground">
          ...
          maintain a safe environment, you agree <strong>not</strong> to use the
          service for:
        </p>
      ...
      <section id="content" className="mb-14 scroll-mt-28">
        ...
        <p className="text-base leading-relaxed text-foreground">
          You represent and warrant that your content does not infringe on the
          intellectual property rights of any third party. You are solely
          responsible for ensuring you have the right to publish your content.
      ...
      <section id="termination" className="mb-14 scroll-mt-28">
        ...
        <p className="text-base leading-relaxed text-foreground">
          ...
          for any user who violates these terms or engages in behavior that
          compromises the security or integrity of the service. You may delete
          your account at any time through the dashboard or by contacting
          support. Upon termination, your data will be permanently deleted
      ...
      <section id="liability" className="mb-14 scroll-mt-28">
        ...
        <p className="text-base leading-relaxed text-foreground">
          ...
          uninterrupted access or perfectly accurate analytics. In no event
          shall Opinion or its maintainers be held liable for any direct,
      ...
      <section id="governing-law" className="mb-14 scroll-mt-28">
        ...
        <p className="text-base leading-relaxed text-foreground">
          ...
          or your use of the platform shall be resolved through informal
          negotiation before any legal action is pursued.
        </p>
      </section>
      ...
      <section id="modifications" className="scroll-mt-28">
        ...
        <p className="text-base leading-relaxed text-foreground">
          ...
          time. Significant changes will be communicated through the platform or
          via the email address associated with your account. Your continued use
          of Opinion following any updates constitutes your acceptance of the
          revised terms.
        </p>
      </section>
    </LegalPageLayout>
