  ...
  return (
    ...
    >
      ...
      <section id="third-party" className="mb-14 scroll-mt-28">
        ...
        <p className="mb-4 text-base leading-relaxed text-foreground">
          Opinion integrates with a minimal set of third-party services to
        ...
        <p className="text-base leading-relaxed text-foreground">
          Each of these providers has been vetted for compliance with modern
          data protection standards. We do not use advertising networks,
          analytics trackers, or social media pixels.
        </p>
      </section>
      ...
      <section id="storage" className="mb-14 scroll-mt-28">
        ...
        <p className="text-base leading-relaxed text-foreground">
          ...
          information. Your data is stored in encrypted databases with
          restricted access. We retain your information only for as long as your
          account remains active, plus a grace period of 90 days after account
          deletion to facilitate recovery. You maintain the right to request
          immediate erasure of your personal data at any time by contacting our
          support team.
        </p>
      </section>
      ...
      <section id="cookies" className="mb-14 scroll-mt-28">
        ...
        <p className="text-base leading-relaxed text-foreground">
          ...
          cookies, third-party analytics pixels, fingerprinting, or cross-site
          tracking mechanisms.
        </p>
      </section>
      ...
      <section id="rights" className="mb-14 scroll-mt-28">
        ...
        <p className="mb-4 text-base leading-relaxed text-foreground">
          You have full control over your personal data. Under applicable data
          protection laws, you are entitled to:
        </p>
